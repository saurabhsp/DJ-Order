...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Online DJ Booking System - Nagpur - Login Page</title>
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('wp7785053-dj-pad-wallpapers.jpg');">
                    <div class="row mx-0 bg-black-op">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-white">
                                    Online DJ Booking System Project Made by Vibhas &amp; Saurabh 
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">DJ SAURABH</span>
                                    </a>
