                 ...
                 <div class="sidebar-content">
                         ...
                         <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                             ...
                             <div class="content-header-item">
                                 <a class="link-effect font-w700" href="dashboard.php">
                                     ...
                                     <span class="font-size-xl text-dual-primary-dark">DJ</span><span class="font-size-xl text-primary">SAURABH &hearts;</span>
                                 </a>
                             </div>
                             <!-- END Logo -->
                         </div>
                     ...
                     <div class="content-side content-side-full content-side-user px-10 align-parent">
                         ...
                         <div class="sidebar-mini-visible-b align-v animated fadeIn">
                             <img class="img-avatar img-avatar32" src="assets/img/avatars/avatar15.jpg" alt="SP">
                         </div>
                         <!-- END Visible only in mini mode -->

                         <!-- Visible only in normal mode -->
                         <div class="sidebar-mini-hidden-b text-center">
                             <a class="img-link" href="http://localhost/DJ%20Order/odms/admin/admin-profile.php">
                                 <img class="img-avatar" src="avatarsp.png" alt="Admin Logo">
                             </a>
                         ...
                         <ul class="nav-main">
                             ...
                             <li>
                                 ...
                                 <ul>
                                     ...
                                     <li>
                                        <a href="waiting-booking.php">Waiting Booking</a>
                                    </li>
