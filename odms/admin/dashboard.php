<!doctype html>
 ...
 <head>
 <title>Online DJ Booking Nagpur - Admin Dashboard</title>
...
?> 
                        ...
                        <div class="col-6 col-md-4 col-xl-4">
                            <a class="block text-center" href="waiting-booking.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                <?php 
$sql ="SELECT ID from tblbooking where Status='Waiting' ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalappbooking=$query->rowCount();
?> 
                                    ...
                                    <p class="font-w600 text-white">Total Waiting Booking </p>
                                </div>
                            </a>
                        </div>
 ...
 <!-- Main Container -->
                ...
                <div class="content">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        <!-- Row #1 -->
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="add-services.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
...
?>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="between-dates-report.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                    ...
                                    <p class="font-w600 text-white">B/W Dates Report</p>
                                </div>
                            </a>
                        </div>
